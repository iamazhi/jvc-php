...
class nav extends control
{
    ...
    {
        parent::__construct();
        $this->config->nav->system = new stdclass();
        $this->config->nav->system->home    = $config->webRoot;
        $this->config->nav->system->company = commonModel::createFrontLink('company', 'index');
        $this->config->nav->system->forum   = commonModel::createFrontLink('forum', 'index');
        $this->config->nav->system->blog    = commonModel::createFrontLink('blog', 'index');
        $this->config->nav->system->book    = commonModel::createFrontLink('book', 'index');
        $this->config->nav->system->message = commonModel::createFrontLink('message', 'index');
    }
